...
void Stack::initialize()
{
  if (!_initialized)
  {
    ...
    if (rc != 0)
    {
      throw Exception("fd_hook_register(fd_null_hook_cb)", rc); 
    }
    ...
    if (_sas_cb_data_hdl == NULL)
    {
      ...
      if (rc != 0)
      {
        throw Exception("fd_hook_data_register", rc); 
      }
    }
    ...
    if (rc != 0)
    {
      throw Exception("fd_hook_register(fd_error_hook_cb)", rc);
    }
    ...
    if (rc != 0)
    {
      throw Exception("fd_hook_register(fd_sas_log_diameter_message)", rc); 
    }
                                    ...
                                    PeerConnectionCB peer_connection_cb)
{
  ...
  if (_peer_connection_cbs.empty())
  {
    ...
    if (rc != 0)
    {
      throw Exception("fd_hook_register", rc); 
    }
  }
                               ...
                               RtOutCB rt_out_cb)
{
  ...
  if (_rt_out_cbs.empty())
  {
    ...
    if (rc != 0)
    {
      throw Exception("fd_rt_out_register", rc); 
    }
  }
                             ...
                             HandlerInterface* handler)
{
  ...
  if (rc != 0)
  {
    throw Exception("fd_disp_register", rc);
  }
}
  ...
  switch (value.GetType())
  {
    ...
    case rapidjson::kNumberType:
      ...
      case AVP_TYPE_GROUPED:
        ...
        break;
      case AVP_TYPE_OCTETSTRING:s).  In those cases, Uint64 is
        // the correct format.
